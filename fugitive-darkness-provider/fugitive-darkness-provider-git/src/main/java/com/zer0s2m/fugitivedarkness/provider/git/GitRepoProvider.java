...
import com.zer0s2m.fugitivedarkness.provider.git.impl.GitRepoProviderGithub;
import com.zer0s2m.fugitivedarkness.provider.git.impl.GitRepoProviderGitlab;
