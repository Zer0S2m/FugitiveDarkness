...
public final class ControllerApiProjectFilesLastCommitFile implements Handler<RoutingContext> {

    static private final Logger logger = LoggerFactory.getLogger(ControllerApiProjectFilesLastCommitFile.class);
