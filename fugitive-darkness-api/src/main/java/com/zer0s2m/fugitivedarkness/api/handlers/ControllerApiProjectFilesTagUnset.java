...
public final class ControllerApiProjectFilesTagUnset implements Handler<RoutingContext> {

    static private final Logger logger = LoggerFactory.getLogger(ControllerApiProjectFilesTagUnset.class);
    ...
    public void handle(RoutingContext event) {
        logger.info("The beginning of untying the file to the project tag");
        ...
        projectFileTagSetRepository
                ...
                .onSuccess(ar -> {
                    ...
                    logger.info("The end of untying the file to the project tag");
     ...
     */
    public static class ProjectFilesTagUnsetValidation {
