...
/**
 * A request handler for binding a color palette to a file in the project.
 */
public final class ControllerApiProjectFilesColorSet implements Handler<RoutingContext> {

    static private final Logger logger = LoggerFactory.getLogger(ControllerApiProjectFilesColorSet.class);
    ...
    public void handle(RoutingContext event) {
        logger.info("The beginning of linking a file to a project color");
        ...
        projectFileColorSetRepository
                ...
                .onSuccess(ar -> {
                    ...
                    logger.info("The end of linking the file to the project color");
     ...
     */
    public static class ProjectFilesColorSetValidation {
