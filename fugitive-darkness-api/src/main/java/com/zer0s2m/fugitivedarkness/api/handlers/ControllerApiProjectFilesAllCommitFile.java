...
public final class ControllerApiProjectFilesAllCommitFile implements Handler<RoutingContext> {

    static private final Logger logger = LoggerFactory.getLogger(ControllerApiProjectFilesAllCommitFile.class);
    ...
    public void handle(RoutingContext event) {
        logger.info("The beginning of receiving the all commits of the file");
        ...
        gitRepoRepository
                ...
                .onSuccess(ar -> {
                    ...
                    Collection<FileCommitInfo> allCommitsInfo = projectManager.allCommitOfFile(
                            sourceGitRepo, commitFileProject.file());

                    JsonObject object = new JsonObject();
                    object.put("success", true);
                    object.put("info", allCommitsInfo);
                    ...
                    logger.info("The end of receiving the all commits of the file");
     ...
     */
    public static class AllCommitFileValidation {
