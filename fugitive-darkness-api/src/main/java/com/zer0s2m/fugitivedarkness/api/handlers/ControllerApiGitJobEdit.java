...
import com.zer0s2m.fugitivedarkness.common.dto.ContainerGitJobEdit;
...
final public class ControllerApiGitJobEdit implements Handler<RoutingContext> {

    static private final Logger logger = LoggerFactory.getLogger(ControllerApiGitJobEdit.class);
    ...
    public void handle(@NotNull RoutingContext event) {
        ...
        final ContainerGitJobEdit containerGitJobEdit = event
                .body()
                .asJsonObject()
                .mapTo(ContainerGitJobEdit.class);
